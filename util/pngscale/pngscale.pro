...
ZLIB_SOURCES	= $$(QTDIR)/src/3rdparty/zlib/adler32.c \
		  $$(QTDIR)/src/3rdparty/zlib/compress.c \
		  $$(QTDIR)/src/3rdparty/zlib/crc32.c \
		  $$(QTDIR)/src/3rdparty/zlib/deflate.c \
		  $$(QTDIR)/src/3rdparty/zlib/gzio.c \
		  $$(QTDIR)/src/3rdparty/zlib/infblock.c \
		  $$(QTDIR)/src/3rdparty/zlib/infcodes.c \
		  $$(QTDIR)/src/3rdparty/zlib/inffast.c \
		  $$(QTDIR)/src/3rdparty/zlib/inflate.c \
		  $$(QTDIR)/src/3rdparty/zlib/inftrees.c \
		  $$(QTDIR)/src/3rdparty/zlib/infutil.c \
		  $$(QTDIR)/src/3rdparty/zlib/trees.c \
		  $$(QTDIR)/src/3rdparty/zlib/uncompr.c \
		  $$(QTDIR)/src/3rdparty/zlib/zutil.c
