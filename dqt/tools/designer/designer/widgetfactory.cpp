...
void QDesignerRadioButton::setFocusPolicy( FocusPolicy policy )
{
    ...
    // We need this check because QButtonGroup::buttonToggled(...) will remove TabFocus,
    ...
    case StrongFocus:
    case WheelFocus:
        QRadioButton::setFocusPolicy( policy );
        return;
    }
    QRadioButton::setFocusPolicy( NoFocus );
}
