...
#define GLOBAL_SETTINGS_FILE "/mnt/user/etc/StartupFlags.conf"
...
void StartupFlags::accept()
{
    ...
    QTranslatableSettings gSettings(GLOBAL_SETTINGS_FILE, QSettings::NativeFormat);
        ...
        if (i) {
            ...
            if (lSettings.contains("State")) {
                ...
                case 2:
                    ...
                    break;
                case 1:
                    s = new QTranslatableSettings(sList.at(0), QSettings::NativeFormat);
                    break;
                default:
                    break;
                }
