...
#ifndef QT_QWS_S3C24A0
#define QT_QWS_S3C24A0
#endif
...
#define QTOPIA_PRELOAD_PHONE_PLUGIN "s3c24a0vendor"

// Define this to use the "advanced" GSM 07.10 CMUX mode instead of "basic".
//#define QTOPIA_ADVANCED_CMUX
//
#define MAX_GSM0710_FRAME_SIZE 1502
#define QTOPIA_EXTRA_CMUX_PARAMS ",254,3,255"
