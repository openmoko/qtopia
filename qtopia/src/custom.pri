...
#
# APP_PROJECTS += myapps/mymediaplayer

# to remove a component from a project list
#
# APP_PROJECTS -= applications/mediaplayer
...
#
# contains( APP_PROJECTS, myapps/mymediaplayer) {
#   PLUGIN_PROJECTS += myplugins/myaudiocodec
# }
