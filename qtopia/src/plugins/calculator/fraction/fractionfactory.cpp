...
QRESULT FractionInterface::queryInterface( const QUuid &uuid, QUnknownInterface **iface )
{
    *iface = 0;
...
QString FractionInterface::pluginName() const { return qApp->translate("Fraction","Fraction"); }
