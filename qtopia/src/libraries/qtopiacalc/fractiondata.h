...
public:
    ...
    int64 getNumerator(){return numerator;};
    int64 getDenominator(){return denominator;};

protected:
    virtual void buildFormattedString();

private:
    int64 findGCM(int64,int64);
    int64 doFindGCM(int64,int64);
