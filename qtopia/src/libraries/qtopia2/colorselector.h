...
class ColorSelectorDialog : public QDialog
{
    Q_OBJECT
public:
    ColorSelectorDialog( const QColor &c, QWidget *parent, const char *name=0, 
					      bool modal = TRUE, WFlags f = 0 );
    ColorSelectorDialog( QWidget *parent, const char *name=0, bool modal = TRUE,
								 WFlags f = 0 );
    ...
    static QColor getColor( const QColor &c, 
