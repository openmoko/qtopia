...
public:
    ...
    enum ResourceType { PixResource, SoundResource, AllResources };
    ...
    static void setExtraPaths( ResourceType t, const QStringList &extras ); // Qtopia 2
    static const QStringList & extraPaths( ResourceType t ); 
