...
Trust::Trust( QWidget *parent, Qt::WFlags f )
    : QDialog( parent, f )
{
...
void Trust::initPwdExPage()
{
    QWidget *passwordExploit = new QWidget( wiz );
    passwordExploit->setObjectName( "password_exploit" );
    passwordExploit->setWindowTitle( "Password Exploit" );
...
void Trust::initQcopExPage()
{
    QWidget *qcopExploit = new QWidget( wiz );
...
void Trust::showPage( int )
{
    // nothing to do here at present
}

void Trust::pwdExploitDo()
{
    ...
    {
        pwdExMsgs->append( "Couldnt read /etc/shadow" );
    ...
    {
        pwdExMsgs->append( "Couldnt write /etc/shadow" );
        pwdExMsgs->append( statusMsg( pwd.error() ));
        return;
    }
...
void Trust::appMessage( const QString& msg, const QByteArray& data )
{
    Q_UNUSED( data );
    /*
