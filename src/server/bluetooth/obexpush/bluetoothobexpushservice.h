...
#ifndef BLUETOOTHOBEXPUSHSERVICE_H
#define BLUETOOTHOBEXPUSHSERVICE_H

#include "filetransfertask.h"
#include "qtopiaserverapplication.h"
#include <QObject>

class BluetoothObexPushServicePrivate;

class BluetoothObexPushService : public FileTransferTask
{
    Q_OBJECT
public:
    BluetoothObexPushService(QObject *parent = 0);
...
private:
    BluetoothObexPushServicePrivate *d;
    friend class BluetoothObexPushServicePrivate;
};
