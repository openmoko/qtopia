...
public:
    ...
    const char *pluginComment() { return "This is the libmpeg3 library written by Adam Williams (heroine.linuxbox.com) which has been modified by Trolltech to use fixed point maths."; }
