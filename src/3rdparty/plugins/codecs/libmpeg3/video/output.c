...
int mpeg3video_ditherframe444(mpeg3video_t *, unsigned char *[])
{
	return 0;
}
...
int mpeg3video_dithertop444(mpeg3video_t *, unsigned char *[])
{
	return 0;
}

int mpeg3video_ditherbot(mpeg3video_t *, unsigned char *[])
{
	return 0;
}

int mpeg3video_ditherbot444(mpeg3video_t *, unsigned char *[])
{
	return 0;
}
...
int mpeg3video_display_second_field(mpeg3video_t *)
{
/* Not used */
	return 0;
}
