...
unix:qdoc=$$fixpath($$DQTDIR/tools/qdoc3/qdoc3)
else:qdoc=$$fixpath($$DQTDIR/tools/qdoc3/$$release/qdoc3)
...
MKDOCS_GENDIR=$$fixpath($$OUT_PWD/src)
MKDOCS_SRC_BUILD=$$fixpath($$QTOPIA_DEPOT_PATH/src/build)
