...
/*
    \req QTOPIA-1702
    \usecase Verify that a task can be created.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1702
    \usecase Verify that if the user attempts to create a task without a description, the task is not created.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1704
    \usecase Verify that a task can be edited.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1703
    \usecase Verify that a task can be removed from the task list.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1704
    \usecase Verify that a task can be marked as complete.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1701
    \usecase User can view summary task list, sorted appropriately
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1706
    \usecase Tasks can be prioritised
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1708
    \usecase It is possible to filter the view of tasks by category. It is possible to hide already completed tasks.
    \revby dac 13/05/2008
*/
...
/*
    \req QTOPIA-1712
    \usecase It is possible to access tasks from other applications via the QDL service interface.
    \revby dac 13/05/2008
*/
    link_tasks: function()
    {
...
/*
    \req
    \usecase The user can launch Tasks in a timely manner.
    \revby rohan 07/04/2008
    \groups Performance
*/
    perf_startup: function()
    {
        Performance.testStartupTime("todolist", "Applications/Tasks");
    }
}
