...
testcase = {
    ...
    {
        waitForQtopiaStart();
// Use the next two lines if the data is completely pear shaped
...
*/
    ...
    {
        snooze_default: [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 22), new QTime(11, 25, 0) ), undefined],
        snooze_5_mins:  [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 22), new QTime(11, 25, 0) ), "5 minutes"],
        snooze_10_mins: [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 22), new QTime(11, 30, 0) ), "10 minutes"],
        snooze_15_mins: [new QDateTime( new QDate( 2004, 2, 28), new QTime(23, 51, 0) ), QDateTime( new QDate( 2004, 2, 29), new QTime(0, 5, 0) ), "15 minutes"],
        snooze_30_mins: [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 22), new QTime(11, 50, 10) ), "30 minutes"],
        snooze_1_hour:  [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 22), new QTime(12, 20, 0) ), "1 hour"],
        snooze_1_day:   [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 23), new QTime(11, 20, 0) ), "1 day"],
        snooze_1_week:  [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 2, 29), new QTime(11, 20, 0) ), "1 week"],
        snooze_1_month: [new QDateTime( new QDate( 2004, 2, 22), new QTime(11, 21, 0) ), QDateTime( new QDate( 2004, 3, 22), new QTime(11, 20, 0) ), "1 month"],
        snooze_no_leap: [new QDateTime( new QDate( 2005, 2, 28), new QTime(23, 51, 0) ), QDateTime( new QDate( 2005, 3, 1),  new QTime(0, 5, 0) ), "15 minutes"]
    },

    snoozing_an_event: function( EventDt, SnoozeDt, SnoozeMode )
    {
        // This test fails because of BUG-226761, but expectFail doesn't catch
        // timeout failures. So, using skip instead...
        skip( "BUG-226761", SkipAll );

        Calendar.setDateTimeSetting( EventDt.addSecs(-120) );
        startApplication("Calendar");
        ...
        if (SnoozeMode != undefined) {
            select( SnoozeMode, signature("Snooze", 1) );
        // FIXME: we really would like to use the next line instead
        //  select( SnoozeMode, "Snooze delay:" );
            if ( getSelectedText() != "Snooze" ) {
                keyClick(Qt.Key_Up);
            }
        }
        select( "Snooze" );

        Calendar.setDateTimeSetting( SnoozeDt );
        waitForTitle( "Calendar", 120000 );
    },
...
*/
    ...
    {
        goto_home: [new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 15, 30) ), new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 16, 0) ), "home"],
        stay_in_calendar: [new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 15, 30) ), new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 16, 0) ), "stay"],
        run_clock: [new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 15, 30) ), new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 16, 0) ), "Clock"],
        run_contacts: [new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 15, 30) ), new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 16, 0) ), "Contacts"],
        run_systemtime: [new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 15, 30) ), new QDateTime( new QDate( 2007, 3, 29), new QTime(11, 16, 0) ), "Settings/Date/Time"]
    },
...
//            startApplication( Mode );
        ...
        waitForTitle(  "Calendar", 40000 );
        // FIXME: make sure we get a reminder at the correct date and time
//        compare( getDateTime(), EventDt );
    },
...
/*
    \req QTOPIA-242
    \usecase User can configure events to repeat non-sequential dates
    \revby dac 26/05/2008
*/
...
*/
    ...
    {
        dubai_test: [ "Los Angeles", 727, new QDateTime( new QDate( 2007, 5, 27), new QTime(23, 0, 0) ) ]
    },
...
*/
    beaming_an_event: function()
    {
        ...
        // Create an event and enter sensible information in all fields.
        select( "New event", optionsMenu() );
        enter( "beam event" );
        keyClick( Qt.Key_Select );
        keyClick( Qt.Key_Back );

        // Beam the event to another Qtopia device.
        keyClick( Qt.Key_Select );
        select( "Send", optionsMenu() );
        ////findItemWithText( "VCalendar vis Infrared", "", 1, 0, 5 );
        compare( getSelectedText(), "VCalendar vis Infrared" );
        keyClick( Qt.Key_Select );

        // Verify that the receiver has the same information in all fields as the original event.
        // TODO???
    },
...
*/
    ...
    {
        Performance.testStartupTime("datebook", "Applications/Calendar");
    }
}
