...
*/
    ...
    // Register to receive notification of when the device is ready to write.
    d->notifier = new QSocketNotifier( d->dspFd, QSocketNotifier::Write );
    QObject::connect( d->notifier, SIGNAL(activated(int)),
		      this, SIGNAL(completedIO()) );
#endif
}
