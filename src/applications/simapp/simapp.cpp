...
SimApp *SimApp::instance()
{
    static SimApp *inst = 0;
    if (!inst)
        inst = new SimApp(0);
    return inst;
}
...
#ifndef QTOPIA_TEST
    if ( value )
        HomeScreenControl::instance()->homeScreen()->installEventFilter(this);
    else
        HomeScreenControl::instance()->homeScreen()->removeEventFilter(this);
#endif
}
...
{
#ifndef QTOPIA_TEST
    if ( o == HomeScreenControl::instance()->homeScreen()
