...
void	tryPlay PROTO(( short, short, short ));
void	sSpanGroup PROTO(( short, short, sPointList * ));
void	spanGroup PROTO(( short, short, pointList *));
void	pause PROTO(());

void	genState PROTO(());
void	initGPUtils PROTO(());
void	genBord PROTO((enum bVal));
...
void	initBoolBoard PROTO((boolBoard));
void	intersectPlist PROTO((pointList *, pointList *, pointList *));
void	initArray PROTO((intBoard));
void	initState PROTO(());
void	copyArray PROTO((intBoard, intBoard));
void	stake PROTO(());
void	spread PROTO(());
void	respreicen PROTO(());
void	tryPlay PROTO((short, short, short));
void	saveState PROTO(());
void	restoreState PROTO(());
short	tencen PROTO((short, short));
void	genConnects PROTO(());
void	sortLibs PROTO(());
