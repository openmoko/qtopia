...
void spanGroupspan(x, y, libs, lookFor)
short x, y, lookFor;
pointList *libs;
  { /* span */
...
void sSpanGroupspan(x, y, libs, lookFor)
short x, y, lookFor;
sPointList *libs;
  { /* span */
    markBoard[x][y] = marker;
...
*/
void Resspan(x, y, gID, gSize, libCount, who)
...
*/
void MLspan(x, y, saw1, sawm1, size, sMark)
