...
/*!
  \fn bool QUuid::operator<(const QUuid &orig) const

  Returns TRUE if the QUuid is ordered before than \a orig.
*/

/*!
  \fn bool QUuid::operator>(const QUuid &orig) const

  Returns TRUE if the QUuid is ordered after than \a orig.
*/
