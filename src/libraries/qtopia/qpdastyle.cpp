...
QPdaStyle::QPdaStyle() : QtopiaStyle()
{
}
...
int QPdaStyle::pixelMetric(PixelMetric metric, const QStyleOption *option,
                            const QWidget *widget) const
{
    // Nothing special yet

    return QtopiaStyle::pixelMetric(metric, option, widget);
}
                              ...
                              const QColorGroup &cg, SFlags flags, const QStyleOption &data) const
{
    ...
    default:
        QtopiaStyle::drawPrimitive( pe, p, r, cg, flags, data );
        break;
    }
}
                            ...
                            const QColorGroup &cg, SFlags how, const QStyleOption &data) const
{
    ...
    default:
        QtopiaStyle::drawControl( ce, p, widget, r, cg, how, data );
        break;
    }
}
                                   ...
                                   SCFlags sub, SCFlags subActive, const QStyleOption &data) const
{
    ...
    case CC_ComboBox:
        ...
        break;
    default:
        QtopiaStyle::drawComplexControl( control, p, widget, r, cg, how,
                                           sub, subActive, data );
        break;
    }
}
...
int QPEStyle::pixelMetric( PixelMetric metric, const QWidget *widget ) const
{
    ...
    switch( metric ) {
        ...
        case PM_SliderLength:
            ...
            break;
        default:
            ret = QtopiaStyle::pixelMetric( metric, widget );
            break;
    }
    return ret;
}
    ...
    case CT_PopupMenuItem:
        {
            if ( !widget || data.isDefault() )
                break;
            sz = QtopiaStyle::sizeFromContents( contents, widget, contentsSize, data );
...
/*! */
void QPEStyle::polishPopupMenu ( QMenu *m )
{
    QtopiaStyle::polishPopupMenu( m );
    m->setLineWidth( 1 );
}
