...
add_input_files_to_rule(configure, $$path(/qtopiacore/qt/tools,project), "*.pr[iof]")
...
sdk [
    ...
    commands=\
        ...
        "#(e)$$QT_PATCH_ENV $$MAKE -C $$QTDIR/src install"\
        ...
        "#(e)$$MKSPEC.SYMBOLIC_LINK $$path(/qtopiacore/qt/doc,project) $$SDKROOT/qtopiacore/host/doc"\
        "#(e):> $$[OUTPUT.0]"
]
