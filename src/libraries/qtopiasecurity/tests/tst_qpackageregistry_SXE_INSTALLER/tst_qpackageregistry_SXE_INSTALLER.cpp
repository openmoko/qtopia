...
/*
    ...
    the class provides "make install" time functionality which is statically
...
/*?
  Test registration of an SXE binary for an sxe_installer run, as make install would
  would work.
*/
void tst_QPackageRegistry_SXE_INSTALLER::tst_registerBinary_SxeInstaller()
{
    ...
    // leave this as null, since packages are installed at make install time not run time
