...
QStringList SmilModule::elementNames() const
{
    QStringList l;
    return l;
}

QStringList SmilModule::attributeNames() const
{
    QStringList l;
    return l;
}
...
SmilModuleAttribute::SmilModuleAttribute(SmilElement *e, const QXmlStreamAttributes &/*atts*/)
    : element(e)
{
    e->addModuleAttribute(this);
}
