...
#if 0
                ::memcpy(currentGroup, groupStart, currentGroupLen);
#endif
...
#if 0
            char * kd = key.key + currentGroupLen + 1;
            for(int ii = 0; ii < (keyEnd - keyStart + 1); ++ii)
                kd[ii] = lower(keyStart[ii]);
#endif
