...
//TESTED_CLASS=MailMessage
//TESTED_FILES=src/libraries/qtopiamail/qmailmessage.cpp

/*
    This class primarily tests that MailMessage correctly handles e-mail messages.
*/
class tst_MailMessage : public QObject
{
    Q_OBJECT

public:
    tst_MailMessage();
    virtual ~tst_MailMessage();
...
QTEST_APP_MAIN( tst_MailMessage, QtopiaApplication )
#include "tst_mailmessage.moc"
...
{
    QMailAddress addr1("bob@home.com");
    QMailAddress addr2("Jim <jim@home.com>");
...
tst_MailMessage::tst_MailMessage()
{
}
...
void tst_MailMessage::initTestCase()
{
}

void tst_MailMessage::cleanupTestCase()
{
}

void tst_MailMessage::init()
{
}
...
*/
void tst_MailMessage::cleanup()
{
}

void tst_MailMessage::toRfc2822_data()
{
    ...
    QString latin1Address("\"Joh\361 D\366e\" <jdoe@machine.net>");
    ...
    unicodeAddress.append(" <address@domain>");
...
"From: =?ISO-8859-1?Q?=22Joh=F1_D=F6e=22?= <jdoe@machine.net>" CRLF
"To: =?UTF-8?B?2LbZqdql2rQ=?= <address@domain>,mary@example.net" CRLF
"Subject: Test" CRLF
...
void tst_MailMessage::toRfc2822()
{
    QFETCH(QString, from);
...
void tst_MailMessage::fromRfc2822_data()
{
...
"From: John Doe <jdoe@machine.example>" CRLF
"Sender: Michael Jones <mjones@machine.example>" CRLF
"To: Mary Smith <mary@example.net>" CRLF
"Subject: Saying Hello" CRLF
...
void tst_MailMessage::fromRfc2822()
{
...
void tst_MailMessage::parentFolderId()
{
    // Tested by: setParentFolderId
}

void tst_MailMessage::setParentFolderId()
{
    QMailFolderId id;
    QMailMessage message;
...
void tst_MailMessage::messageType()
{
    // Tested by: setMessageType
}

void tst_MailMessage::setMessageType()
{
    QMailMessage message;
...
void tst_MailMessage::from()
{
    // Tested by: setFrom
}

void tst_MailMessage::setFrom()
{
    testAddressHeader("From", &QMailMessage::setFrom, &QMailMessage::from);
}

void tst_MailMessage::subject()
{
    // Tested by: setSubject
}

void tst_MailMessage::setSubject()
{
    testHeader("Subject", &QMailMessage::setSubject, &QMailMessage::subject);
}

void tst_MailMessage::date()
{
    // Tested by: setDate
}

void tst_MailMessage::setDate()
{
...
void tst_MailMessage::to()
{
    // Tested by: setTo
}

void tst_MailMessage::setTo_data()
{
...
void tst_MailMessage::cc()
{
    // Tested by: setTo
}

void tst_MailMessage::setCc()
{
    // Tested by: setTo
}

void tst_MailMessage::bcc()
{
    // Tested by: setTo
}

void tst_MailMessage::setBcc()
{
    // Tested by: setTo
}

void tst_MailMessage::replyTo()
{
    // Tested by: setReplyTo
}

void tst_MailMessage::recipients_data()
{
...
void tst_MailMessage::recipients()
{
...
void tst_MailMessage::copyAndAssign()
{
    QMailMessage m1;
    QMailMessage m2;
    QMailMessage m3(m1);
