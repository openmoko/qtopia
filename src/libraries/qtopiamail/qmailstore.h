...
public:
    ...
    QMailMessageRemovalRecordList messageRemovalRecords(const QMailMessageIdList& idList) const;
    ...
    bool purgeMessageRemovalRecord(const QMailAccountId& parentAccountId, const QString& serverUid);
    bool purgeMessageRemovalRecords(const QMailMessageIdList& ids);
...
signals:
    ...
    void messageRemovalRecordsAdded(const QMailMessageIdList& ids);
    void messageRemovalRecordsRemoved(const QMailMessageIdList& ids);
...
private:
    ...
    AttemptResult attemptMessageRemovalRecords(const QMailMessageIdList& idList, QMailMessageRemovalRecordList *result, MailStoreReadLock&) const;
    ...
    AttemptResult attemptPurgeMessageRemovalRecord(const QMailAccountId &accountId, const QString &serverUid, MailStoreTransaction& t);
    AttemptResult attemptPurgeMessageRemovalRecords(const QMailMessageIdList &ids, MailStoreTransaction& t);
