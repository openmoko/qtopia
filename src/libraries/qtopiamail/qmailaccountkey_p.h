...
class QMailAccountKeyPrivate : public QSharedData
{
public:
    typedef QMailKeyArgument<QMailAccountKey::Property> Argument;

    QMailAccountKeyPrivate() : QSharedData(),
