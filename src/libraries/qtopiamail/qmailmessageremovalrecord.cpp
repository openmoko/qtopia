...
/*!
    Returns the identifier of the message removal record, which is the same as that of
    the now-defunct message that it represents.
*/
QMailMessageId QMailMessageRemovalRecord::id() const
{
    return d->id;
}

/*!
    Sets the identifier of the message removal record to \a id.
*/
void QMailMessageRemovalRecord::setId(const QMailMessageId& id)
{
    d->id = id;
}
