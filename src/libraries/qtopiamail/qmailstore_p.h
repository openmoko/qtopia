...
class QMailAccount;
class QSettings;
struct QMailMessageRemovalRecord;
class ProcessMutex;
...
public:
    ...
    bool updateMessageBody(const QString& fileName, const QMailMessage& data);
...
private:
    ...
    void messageMetaData(const QSqlRecord& r, const QMailMessageKey::Properties& properties, QMailMessageMetaData* metaData) const;
