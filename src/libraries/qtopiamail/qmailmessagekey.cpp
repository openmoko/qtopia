...
/*!
    ...
    and a comparison value. The QMailMessageKey class is used in conjunction with the QMailStore::query() 
    ...
    QMailIdList results = QMailStore::query(subjectKey & senderKey);
    \endcode
