...
public:
    ...
    QStringList serverUids(const QMailFolderId &boxId) const;
    QStringList serverUids(const QMailFolderId &boxId, quint64 messageStatusFilter, bool set = true) const;

    QStringList deletedMessages() const;
    QStringList deletedMessages(const QMailFolderId &boxId) const;
