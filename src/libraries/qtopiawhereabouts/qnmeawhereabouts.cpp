...
{
    //qDebug() << "QNmeaRealTimeReader::sourceReadyRead()";
...
{
    //qDebug() << "QNmeaSimulatedReader::sourceReadyRead()";
...
{
    //qDebug() << "QNmeaSimulatedReader::simulatePendingUpdate()";
...
{
    //qDebug() << "QNmeaSimulatedReader::processNextSentence()";
...
{
    //qDebug() << "QNmeaWhereaboutsPrivate::startUpdates()" << m_whereabouts->updateInterval();
    m_invokedStart = true;
...
{
    //qDebug() << "QNmeaWhereaboutsPrivate::stopUpdates()";
    m_invokedStart = false;
    if (m_updateTimer)
        m_updateTimer->stop();
    m_pendingUpdate.clear();
...
{
    //qDebug() << "QNmeaWhereaboutsPrivate::notifyNewUpdate" << m_invokedStart << fixStatus << update->updateTime().toString("hh:mm:ss:zzz");
