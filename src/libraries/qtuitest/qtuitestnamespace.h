...
namespace QtUiTest
{
    ...
    QTUITEST_EXPORT bool connect(const QObject*, const char*, const QObject*, const char*,
                 QtUiTest::ConnectionType);
    QTUITEST_EXPORT bool disconnect(const QObject*, const char*, const QObject*, const char*);
