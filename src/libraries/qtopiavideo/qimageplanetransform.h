...
public:
    ...
    void setSrcGeometry( const QRect& srcRect, const QRect& srcArea, int srcLineStep );
    void setDstGeometry( const QRect& srcRect, const QRect& srcArea, int dstLineStep );
