...
class BrightnessControl : public QFrame
{
    Q_OBJECT

public:
    BrightnessControl( QWidget *parent=0, const char *name=0, WFlags f=0 );
...
private:
    int			calcBrightnessValue(void);
    int			calcSliderValue(void);
