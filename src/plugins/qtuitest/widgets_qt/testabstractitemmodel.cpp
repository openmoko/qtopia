...
TestAbstractItemModel::TestAbstractItemModel(QObject* _q)
    : model(qobject_cast<TestModelViewWrapper*>(_q)->model),
      view (qobject_cast<TestModelViewWrapper*>(_q)->view)
{}
...
{
    TestModelViewWrapper* w = qobject_cast<TestModelViewWrapper*>(o);
    return w && w->model;
}
