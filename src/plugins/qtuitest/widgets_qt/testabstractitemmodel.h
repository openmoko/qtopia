...
#ifndef TESTABSTRACTITEMMODEL_H
#define TESTABSTRACTITEMMODEL_H
...
class TestAbstractItemModel : public QObject, public QtUiTest::ListWidget
{
    Q_OBJECT
    Q_INTERFACES(QtUiTest::ListWidget)

public:
    TestAbstractItemModel(QObject*);
