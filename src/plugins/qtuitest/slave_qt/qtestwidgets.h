...
public:
    ...
    bool getCurrentTitle( QString &title, QString &error, int timeout = VISIBLE_RESPONSE_TIME );
    bool widgetAt(QPoint const &p, QTestWidget *&widget, QString &error);
