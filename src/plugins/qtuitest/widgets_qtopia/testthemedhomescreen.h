...
#ifndef TESTTHEMEDHOMESCREEN_H
#define TESTTHEMEDHOMESCREEN_H

#include "testwidget.h"
class ThemedView;
class TestThemedHomeScreen : public TestWidget,
...
private:
    QWidget *dialer() const;
    bool raiseDialer() const;
    bool hideDialer() const;

    QWidget *q;
    mutable QWidget *m_dialer;
