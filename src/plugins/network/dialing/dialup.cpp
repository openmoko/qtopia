    ...
    if ( t & QtopiaNetwork::NamedModem || t & QtopiaNetwork::PCMCIA ) {
        ...
        if ( callManager ) {
            ...
            dataCall.connectNotification( this, 
                    SLOT(connectNotification(const QPhoneCall&, QPhoneCall::Notification, const QString&)));
            dataCall.connectStateChanged( this, SLOT(phoneCallStateChanged(const QPhoneCall&)) );
...
#ifdef QTOPIA_CELL
void DialupImpl::connectNotification( const QPhoneCall& call, 
