...
QString LightStyleImpl::name() const
{
    return QString("Light");
}

QRESULT LightStyleImpl::queryInterface( const QUuid &uuid, QUnknownInterface **iface )
{
    *iface = 0;
...
Q_EXPORT_INTERFACE()
{
    Q_CREATE_INSTANCE( LightStyleImpl )
}
