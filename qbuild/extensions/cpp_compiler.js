...
\row \o Input
     \o TARGET
     \o Target name.  The project's simple name is used if not specified.
\row \o Input
...
###
        ...
        singleexec_link:COMPILER.STATICLIB = $${COMPILER.TARGETDIR}/lib$${COMPILER.TARGET}.o
        else:COMPILER.STATICLIB = $${COMPILER.TARGETDIR}/lib$${COMPILER.TARGET}.a
...
###
    ...
    singleexec_link {
        QBUILD_LINK_STATICLIB_IMPL = "#(eh)echo $$COMPILER.LINK -r $$[OUTPUT.0]"\
                                     "#(E)$$COMPILER.LINK -nostdinc -nostdlib -r -o $$[OUTPUT.0] $$[INPUT]"
        QBUILD_LINK_STATICLIB_TEST = "$$COMPILER.LINK -nostdinc -nostdlib -r"
    } else {
