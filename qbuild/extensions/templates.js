...
###
    ...
    singleexec_link {
        ...
        TEMPLATES.DEP1.libs.EVAL="!contains(LIBS,"$$path($$lib,generated)"/lib"$$TARGET".o):LIBS="$$path($$lib,generated)"/lib"$$TARGET".o $$LIBS"
    } else {
        TEMPLATES.DEP1.libs.TYPE=DEPENDS PERSISTED SDK
        TEMPLATES.DEP1.libs.EVAL="!contains(LIBS,-l"$TARGET"):LIBS=-l"$$TARGET" $$LIBS"
    }
