    ...
    : QWidget(parent, f)
{
    ...
    // Construct context menu, available to the user via the Qt Extended soft menu bar.
    ...
    // Tell Qt Extended to provide the "Help" option, which will enable the user to
