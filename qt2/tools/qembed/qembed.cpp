/****************************************************************************
** $Id: qt/tools/qembed/qembed.cpp   2.3.12   edited 2005-10-27 $
**
...
int main( int argc, char **argv )
{
  ...
  // Generate summery
	...
	out << "\n"
	    "inline static const QByteArray& qembed_findData(const char* name)\n"
	    "{\n"
	...
	out << "\n"
	    ...
	    "    return strcmp(ea->name,eb->name);\n"
	    "}\n"
	    "inline static QImage qembed_findImage(const char* name)\n"
	    "{\n"
