/****************************************************************************
** $Id: qt/src/dialogs/qfiledialog.cpp   2.3.12   edited 2005-10-27 $
**
...
/*!
  ...
  If \a parent is provided, the dialog will be centered
  over \a parent. If \a name is provided, it will be
  \link QObject::name() named \endlink \a name.
...
/*!
  ...
  \brief The QFilePreview class is an abstract preview widget for the QFileDialog.
