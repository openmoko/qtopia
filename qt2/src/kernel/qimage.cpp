/****************************************************************************
** $Id: qt/src/kernel/qimage.cpp   2.3.12   edited 2005-10-27 $
**
...
void
QImageSmoothScalerPrivate::setup(const int srcWidth, const int srcHeight,
...
int
QImageSmoothScaler::scaledWidth(void) const
{
    return d->cols;
}

QImageSmoothScaler::~QImageSmoothScaler(void)
{
    delete d;
}

inline QRgb*
QImageSmoothScaler::scanLine(const int line, const QImage *src)
{
    return (QRgb*)src->scanLine(line);
}

QImage
QImageSmoothScaler::scale(void)
{
    long    SCALE;
    long    HALFSCALE;
    QRgb    *xelrow = 0;
...
QImage QImage::smoothScale(int w, int h) const
{
    ...
    if (depth()==32) {
	QImageSmoothScaler scaler(w, h, *this);
	return scaler.scale();
...
/*!
    ...
    be found in
    <a href="http://www.libpng.org/pub/png/spec/PNG-Chunks.html#C.Anc-text">
