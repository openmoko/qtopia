/****************************************************************************
** $Id: qt/src/kernel/qrichtext_p.h   2.3.12   edited 2005-10-27 $
**
...
{
public:
    QtTriple() : a(-1), b(-1), c(-1) {}
    QtTriple(int a_, int b_, int c_):a(a_),b(b_),c(c_){};
    bool isNull() const { return a == -1 && b == -1 && c == -1; }
    int a,b,c;
};
...
public:
    ...
    void setSelectedAnchor(const QString &a, const QtTriple &s, const QtTriple &e) 
    { selectedanchor = a; selectedanchorstartpos = s; selectedanchorendpos = e; }
    QString selectedAnchor() const { return selectedanchor; }
    QtTriple selectedAnchorStartPos() const{ return selectedanchorstartpos; }
    QtTriple selectedAnchorEndPos() const{ return selectedanchorendpos; }
#endif
private:
    ...
    QtTriple selectedanchorstartpos;
    QtTriple selectedanchorendpos;
#endif
