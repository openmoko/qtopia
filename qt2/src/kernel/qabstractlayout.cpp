/****************************************************************************
** $Id: qt/src/kernel/qabstractlayout.cpp   2.3.12   edited 2005-10-27 $
**
...
#include "qglobal.h"
#if !defined( _OS_WIN32_ ) && !defined(__CYGWIN__)
// Workaround for gcc 2.96 compiler bug, gives linker error for
// all Windows compilers.
#define Q_HIDE_QSIZEPOLICY_INLINE
#endif
...
#ifdef Q_HIDE_QSIZEPOLICY_INLINE
...
/*!
  ...
  \brief The QGLayoutIterator class is the abstract base class of internal layout iterators.
