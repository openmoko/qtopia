/****************************************************************************
** $Id: qt/src/kernel/qaccel.cpp   2.3.12   edited 2005-10-27 $
**
...
static struct {
    ...
    { Qt::Key_Select,	QT_TRANSLATE_NOOP( "QAccel", "Select" ) },
    { Qt::Key_Back,	QT_TRANSLATE_NOOP( "QAccel", "Back" ) },
    { Qt::Key_Context1,	QT_TRANSLATE_NOOP( "QAccel", "Context1" ) },
    { Qt::Key_Context2,	QT_TRANSLATE_NOOP( "QAccel", "Context2" ) },
    { Qt::Key_Context3,	QT_TRANSLATE_NOOP( "QAccel", "Context3" ) },
    { Qt::Key_Context4,	QT_TRANSLATE_NOOP( "QAccel", "Context4" ) },
    { Qt::Key_Yes,	QT_TRANSLATE_NOOP( "QAccel", "Yes" ) },
    { Qt::Key_No,	QT_TRANSLATE_NOOP( "QAccel", "No" ) },
    { Qt::Key_Call,	QT_TRANSLATE_NOOP( "QAccel", "Call" ) },
    { Qt::Key_Hangup,	QT_TRANSLATE_NOOP( "QAccel", "Hangup" ) },
    { Qt::Key_Flip,	QT_TRANSLATE_NOOP( "QAccel", "Flip" ) },
#endif
