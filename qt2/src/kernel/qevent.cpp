/****************************************************************************
** $Id: qt/src/kernel/qevent.cpp   2.3.12   edited 2005-10-27 $
**
...
/*!
  ...
  \brief The QDragEnterEvent class is the event sent to widgets when a drag-and-drop first drags onto it.
...
/*!
  ...
  \brief The QDragLeaveEvent class is the event sent to widgets when a drag-and-drop leaves it.
...
/*!
  ...
  \brief The QHideEvent class is the event sent after a widget is hidden.
...
/*!
  ...
  \brief The QShowEvent class is the event sent when a widget is shown.
