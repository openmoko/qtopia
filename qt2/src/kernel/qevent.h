/****************************************************************************
** $Id: qt/src/kernel/qevent.h   2.3.12   edited 2005-10-27 $
**
...
public:
	...
	EnterModalEdit = 100,			// enter modal edit in keypad mode
	LeaveModalEdit = 101,			// leave modal edit in keypad mode
#endif
