/****************************************************************************
** $Id: qt/src/kernel/qstyle.h   2.3.12   edited 2005-10-27 $
**
...
public:
	...
	TabHMargin,
	LastPixelMetric };
    int pixelMetric(PixelMetric) const;

    // Not in Qt 2.3.7
    enum ExtendedColor {
	AlternateBase,
	LastExtendedColor };
    QBrush extendedBrush(ExtendedColor) const;
    // Not in Qt 2.3.7
    void setExtendedBrush(ExtendedColor, const QBrush &);
...
protected:
    ...
    // Not in Qt 2.3.7
    void setPixelMetric(PixelMetric, int);
