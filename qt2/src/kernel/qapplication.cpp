/****************************************************************************
** $Id: qt/src/kernel/qapplication.cpp   2.3.12   edited 2005-10-27 $
**
...
#ifndef QT_NO_QWS_IM
QBrush *qt_im_compose_background = 0;
#endif
#ifdef QT_KEYPAD_MODE
static QWidget *old_modal_editing_widget = 0;
...
#if !defined(QT_NO_TRANSLATION) && !defined(QT_NO_TEXTCODEC)
...
/*!
  ...
  \a scope is typically a class name (e.g. \c MyDialog) and \a key is
...
{
    return postedEvents ? postedEvents->count() : 0;
}
...
void QApplication::setActiveWindow( QWidget* act )
{
	...
	if( qt_modalEditingEnabled ) {
	    if ( focus_widget->isModalEditing() ) {
		old_modal_editing_widget = focus_widget;
		focus_widget->setModalEditing( FALSE );
	    } else {
		old_modal_editing_widget = 0;
	    }
	}
#endif
