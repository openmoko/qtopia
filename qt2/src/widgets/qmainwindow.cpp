/****************************************************************************
** $Id: qt/src/widgets/qmainwindow.cpp   2.3.12   edited 2005-10-27 $
**
...
new line of tool bars if \a newLine is TRUE.
...
/*!
  ...
  The \a ipos parameter can be 0, to position before, or 1, to position
  after the \a relative item.
...
#endif
	if ( o == this && centralWidget() && !centralWidget()->isVisible() ) {
	    centralWidget()->show();
	}
