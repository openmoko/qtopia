/****************************************************************************
** $Id: qt/src/widgets/qwhatsthis.cpp   2.3.12   edited 2005-10-27 $
**
...
void QWhatsThisPrivate::say_helper(QWidget* widget,const QPoint& ppos,bool init)
{
	...
	doc->adjustSize();
	if ( doc->width() > QApplication::desktop()->width() - shadowWidth - 2*hMargin ) {
	    doc->setWidth( QApplication::desktop()->width() - shadowWidth - 2*hMargin );
	}
