/****************************************************************************
** $Id: qt/src/widgets/qmenubar.cpp   2.3.12   edited 2005-10-27 $
**
...
bool QMenuBar::eventFilter( QObject *object, QEvent *event )
{
    ...
    if ( waitforalt && event->type() == QEvent::FocusOut ) {
