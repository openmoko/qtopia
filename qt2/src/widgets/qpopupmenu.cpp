/****************************************************************************
** $Id: qt/src/widgets/qpopupmenu.cpp   2.3.12   edited 2005-10-27 $
**
...
# ifdef QT_KEYPAD_MODE // ### Effects really needs to be able to have a direction hint set
    if ( parentWidget() && parentWidget()->isA("ContextMenu") )
	vGuess = QEffects::UpScroll;
    bool avoidScrollView = child(0, "QScrollView");
# endif
