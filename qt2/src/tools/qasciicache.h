/****************************************************************************
** $Id: qt/src/tools/qasciicache.h   2.3.12   edited 2005-10-27 $
**
...
template<> inline void QAsciiCache<void>::deleteItem( Item )
{
}
#endif

template<class type> inline void QAsciiCache<type>::deleteItem( QCollection::Item d )
{
