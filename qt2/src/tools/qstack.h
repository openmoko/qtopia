/****************************************************************************
** $Id: qt/src/tools/qstack.h   2.3.12   edited 2005-10-27 $
**
...
template<> inline void QStack<void>::deleteItem( Item )
{
}
#endif

template<class type> inline void QStack<type>::deleteItem( QCollection::Item d )
{
