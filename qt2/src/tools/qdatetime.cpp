/****************************************************************************
** $Id: qt/src/tools/qdatetime.cpp   2.3.12   edited 2005-10-27 $
**
...
#ifndef QT_BUILDING_MOC
# ifdef _WS_QWS_
static const char* untranslatedMonthNames[] = {
    QT_TRANSLATE_NOOP( "QDate", "Jan" ),
    QT_TRANSLATE_NOOP( "QDate", "Feb" ),
    QT_TRANSLATE_NOOP( "QDate", "Mar" ),
    QT_TRANSLATE_NOOP( "QDate", "Apr" ),
    QT_TRANSLATE_NOOP( "QDate", "May" ),
    QT_TRANSLATE_NOOP( "QDate", "Jun" ),
    QT_TRANSLATE_NOOP( "QDate", "Jul" ),
    QT_TRANSLATE_NOOP( "QDate", "Aug" ),
    QT_TRANSLATE_NOOP( "QDate", "Sep" ),
    QT_TRANSLATE_NOOP( "QDate", "Oct" ),
    QT_TRANSLATE_NOOP( "QDate", "Nov" ),
    QT_TRANSLATE_NOOP( "QDate", "Dec" )
};

static const char* translatedDayNames[] = {
...
#ifndef QT_BUILDING_MOC
# ifdef _WS_QWS_
    // try tr if qApp exists. (e.g. used in gui)
    if (qApp)
	return qApp->translate("QDate",  untranslatedMonthNames[month-1] );
# endif
#endif
    char buffer[255];
    tm tt;
...
# ifdef _WS_QWS_
    if (qApp)
	return qApp->translate("QDate", translatedDayNames[weekday?weekday-1:7] );
# endif
#endif
    char buffer[255];
    tm tt;
